...
export default function VerifyOtpScreen() {
    ...
    const handleVerifyPhone = async () => {
        ...
        try {
            const res = await apiRequestDirect("POST", "http://65.2.10.30:3001/auth/verify-phone", {
                otp: otpValue,
                phone,
            });
    ...
    const handleVerifyEmail = async () => {
        ...
        try {
            const res = await apiRequestDirect("POST", "http://65.2.10.30:3001/auth/verify-email", {
                otp: otpValue,
                email,
            });
            const data = await res.json();

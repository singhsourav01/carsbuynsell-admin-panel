...
export default function VerifyOtpScreen() {
    ...
    const handleVerifyPhone = async () => {
        ...
        try {
            const res = await apiRequestDirect("POST", "http://192.168.1.102:8000/auth/verify-phone", {
                otp: otpValue,
                phone,
            });
    ...
    const handleVerifyEmail = async () => {
        ...
        try {
            const res = await apiRequestDirect("POST", "http://192.168.1.102:8000/auth/verify-email", {
                otp: otpValue,
                email,
            });
            const data = await res.json();

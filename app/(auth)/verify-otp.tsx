...
export default function VerifyOtpScreen() {
    ...
    const handleVerifyPhone = async () => {
        ...
        try {
            const res = await apiRequestDirect("POST", "http://13.127.188.130:3001/auth/verify-phone", {
                otp: otpValue,
                phone,
            });
    ...
    const handleVerifyEmail = async () => {
        ...
        try {
            const res = await apiRequestDirect("POST", "http://13.127.188.130:3001/auth/verify-email", {
                otp: otpValue,
                email,
            });
            const data = await res.json();

...
export default function VerifyEmailScreen() {
  ...
  const handleVerify = async () => {
    ...
    try {
      const res = await apiRequest("POST", "/api/auth/verify-email", { userId, otp: otpValue }, false);
  ...
  const handleResend = async () => {
    ...
    try {
      const res = await apiRequest("POST", "/api/auth/resend-otp", { userId, type: "email" }, false);
      const data = await res.json();
